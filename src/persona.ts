...
export function getSharpLine(): string { return pick(SHARP_LINES); }
export function getCityRule(): string { return pick(CITY_RULES); }
export function getComfort(): string { return pick(SOFT_LINES); }
export function getSolemnComfort(): string { return pick(SERIOUS_LINES); }
...
export function getNickname(): string { return `今天你的标签：${pick(NICK)}`; }
